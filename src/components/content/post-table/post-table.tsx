                ...
                {(() => {
                  ...
                  return (
                    <>
                      <TableCell
                        colSpan={3}
                        className="px-3 py-3 bg-white border-t border-b border-elementStroke"
                        style={{
                      ...
                      {restOfCols.map((col, index) => (
                        <TableCell
                          key={col.id}
                          className={cn(
                            "px-3 py-3 bg-white border-t border-b border-elementStroke"
                          )}
                          style={{
                            width: col.getSize(),
                          }}
                ...
                {(() => {
                  ...
                  return (
                    <>
                      <TableCell
                        colSpan={3}
                        className="px-3 py-3 bg-white border-t border-elementStroke"
                        style={{
                          ...stickyStyles("drag", 10),
                          width: stickyWidth,
                        }}
                      ...
                      {restOfCols.map((col, index) => (
                        <TableCell
                          key={col.id}
                          className={cn(
                            "px-3 py-3 bg-white border-t border-elementStroke"
                          )}
                          style={{
                            width: col.getSize(),
                          }}
        ...
        <CellFocusProvider>
          <div className="flex-1 bg-[#F8F8F8] relative">
            ...
            {grouping.length === 0 && isScrollable && (
              <div className="absolute bottom-2 px-3 py-3 left-1 right-0 bg-white border-t border-elementStroke z-10">
