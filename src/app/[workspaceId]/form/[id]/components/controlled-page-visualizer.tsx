...
import InputRender from "../controlled/input-render";
          ...
          {pageIndex === 0 && formData?.coverUrl && (
            <div className="w-full relative h-[160px]">
              <Image
                ...
                height={160}
                style={{
                  objectPosition: `50% ${formData?.coverOffset ?? 50}%`,
                }}
          ...
          <div className="flex flex-col p-8">
            <div className="flex flex-col gap-1 pb-10">
              <span className="text-[24px] font-semibold text-black">
                {pageIndex === 0
                  ? formData?.title
                  : pages[pageIndex - 1]?.length && pages[pageIndex - 1][pages[pageIndex - 1].length - 1]
